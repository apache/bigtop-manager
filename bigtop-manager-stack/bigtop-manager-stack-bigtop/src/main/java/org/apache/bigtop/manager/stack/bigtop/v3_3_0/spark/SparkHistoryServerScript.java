...
public class SparkHistoryServerScript extends AbstractServerScript {
    ...
    public ShellResult start(Params params) {
        ...
        String cmd = MessageFormat.format("{0}/sbin/start-history-server.sh", sparkParams.serviceHome());
        try {
    ...
    public ShellResult stop(Params params) {
        SparkParams sparkParams = (SparkParams) params;
        String cmd = MessageFormat.format("{0}/sbin/stop-history-server.sh", sparkParams.serviceHome());
        try {
            return LinuxOSUtils.sudoExecCmd(cmd, sparkParams.user());
        } catch (IOException e) {
            throw new StackException(e);
