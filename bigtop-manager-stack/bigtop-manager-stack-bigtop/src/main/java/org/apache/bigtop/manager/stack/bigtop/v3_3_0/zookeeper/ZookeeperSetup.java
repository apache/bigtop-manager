...
public class ZookeeperSetup {
    ...
    public static ShellResult config(Params params) {
        ...
        LinuxFileUtils.createDirectories(zookeeperParams.getZookeeperDataDir(), zookeeperUser, zookeeperGroup,
                PERMISSION_755, true);
        LinuxFileUtils.createDirectories(zookeeperParams.getZookeeperLogDir(), zookeeperUser, zookeeperGroup,
                PERMISSION_755, true);
        LinuxFileUtils.createDirectories(zookeeperParams.getZookeeperPidDir(), zookeeperUser, zookeeperGroup,
                PERMISSION_755, true);
        ...
        // myid
        LinuxFileUtils.toFile(ConfigType.CONTENT,
        ...
        // zookeeper-env
        LinuxFileUtils.toFileByTemplate(zookeeperEnv.get("content").toString(),
