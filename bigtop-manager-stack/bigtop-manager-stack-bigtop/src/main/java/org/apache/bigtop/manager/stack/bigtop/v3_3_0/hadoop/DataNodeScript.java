...
public class DataNodeScript extends AbstractServerScript {
    ...
    public ShellResult start(Params params) {
        ...
        String cmd = MessageFormat.format("{0}/hdfs --daemon start datanode", hadoopParams.binDir());
        try {
    ...
    public ShellResult stop(Params params) {
        HadoopParams hadoopParams = (HadoopParams) params;
        String cmd = MessageFormat.format("{0}/hdfs --daemon stop datanode", hadoopParams.binDir());
        try {
            return LinuxOSUtils.sudoExecCmd(cmd, hadoopParams.user());
        } catch (Exception e) {
            throw new StackException(e);
    ...
    public ShellResult status(Params params) {
        HadoopParams hadoopParams = (HadoopParams) params;
        return LinuxOSUtils.checkProcess(hadoopParams.getDataNodePidFile());
    }
