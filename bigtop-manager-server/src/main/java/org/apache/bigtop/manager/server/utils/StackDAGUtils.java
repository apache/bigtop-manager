...
public class StackDAGUtils {
    ...
    public static List<String> orderTodoList(List<String> componentCommandNames) {
        try {
    ...
    public static List<String> getTodoList(List<String> componentNames, Command command) {
        try {
            List<String> orderedList =
                    StackUtils.DAG.getAllNodesList().isEmpty() ? new ArrayList<>() : StackUtils.DAG.topologicalSort();
