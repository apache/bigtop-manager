...
public class ClusterStopJobTest {
    ...
    public void testCreateStages() {
        ...
        ReflectionTestUtils.setField(clusterStopJob, "jobContext", jobContext);
        ReflectionTestUtils.setField(clusterStopJob, "stages", stages);
