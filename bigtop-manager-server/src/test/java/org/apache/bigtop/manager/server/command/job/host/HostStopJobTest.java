...
public class HostStopJobTest {
    ...
    public void setUp() {
        ...
        hostStopJob = mock(HostStopJob.class);
        ...
        hostStopJob.injectBeans();

        doCallRealMethod().when(hostStopJob).loadJobPO(any());
        lenient().when(hostStopJob.getJobPO()).thenCallRealMethod();
        hostStopJob.loadJobPO(jobPO);
    }
    ...
    public void testBeforeCreateStages() {
        doCallRealMethod().when(hostStopJob).beforeCreateStages();
