...
public class HostStopJobTest {
    ...
    @Mock
    private HostStopJob hostStopJob;
    ...
    public void testCreateStages() {
        ...
        ReflectionTestUtils.setField(hostStopJob, "jobContext", jobContext);
        ReflectionTestUtils.setField(hostStopJob, "stages", stages);
    ...
    public void testGetName() {
        doCallRealMethod().when(hostStopJob).getName();
        assertEquals("Stop host", hostStopJob.getName());
    }
}
