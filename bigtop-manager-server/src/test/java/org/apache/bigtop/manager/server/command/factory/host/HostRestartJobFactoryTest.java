...
class HostRestartJobFactoryTest {

    private HostRestartJobFactory factory;

    @BeforeEach
    void setUp() {
        factory = new HostRestartJobFactory();
    }
    ...
    void testGetCommandIdentifier() {
        ...
        assertEquals(CommandLevel.HOST, actualIdentifier.getCommandLevel());
