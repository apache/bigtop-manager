...
public class ServiceConfigureJobTest {
    ...
    public void testCreateStages() {
        ...
        ReflectionTestUtils.setField(serviceConfigureJob, "jobContext", jobContext);
        ReflectionTestUtils.setField(serviceConfigureJob, "stages", stages);
        ...
        List<Stage> stageList1 = List.of(mock(ComponentConfigureStage.class));
        List<Stage> stageList2 = List.of(mock(ComponentStopStage.class));
        List<Stage> stageList3 = List.of(mock(ComponentStartStage.class));
